function init() {
  ...
  socket.on('topology_data', function(topologyData){
  ...
  /*
  connectionsDict = [{'from': '192.168.1.1', 'to': '192.168.1.2', 'fromInt': 'GigabitEthernet0/0/2', 'toInt': 'GigabitEthernet1/0/1'}, {'from': '192.168.1.1', 'to': '192.168.4.1', 'fromInt': 'GigabitEthernet0/0/0', 'toInt': 'GigabitEthernet0/0/0'}, {'from': '192.168.1.1', 'to': '192.168.2.1', 'fromInt': 'GigabitEthernet0/0/1', 'toInt': 'GigabitEthernet0/0/0'}, {'from': '192.168.4.1', 'to': '192.168.1.1', 'fromInt': 'GigabitEthernet0/0/0', 'toInt': 'GigabitEthernet0/0/0'}, {'from': '192.168.4.1', 'to': '192.168.2.1', 'fromInt': 'GigabitEthernet0/0/1', 'toInt': 'GigabitEthernet0/0/1'}, {'from': '192.168.2.1', 'to': '192.168.4.1', 'fromInt': 'GigabitEthernet0/0/1', 'toInt': 'GigabitEthernet0/0/1'}, {'from': '192.168.2.1', 'to': '192.168.1.1', 'fromInt': 'GigabitEthernet0/0/0', 'toInt': 'GigabitEthernet0/0/1'}, {'from': '192.168.1.2', 'to': '192.168.1.1', 'fromInt': 'GigabitEthernet1/0/1', 'toInt': 'GigabitEthernet0/0/2'}];

  nodesDict = [{'key': '192.168.1.1', 'foot': 'R2', 'img': 'static/img/router-svgrepo-com.svg'}, {'key': '192.168.4.1', 'foot': 'R1', 'img': 'static/img/router-svgrepo-com.svg'}, {'key': '192.168.2.1', 'foot': 'R3', 'img': 'static/img/router-svgrepo-com.svg'}, {'key': '192.168.1.2', 'foot': 'S1', 'img': 'static/img/switch.svg'}];
